<?php
	...
	$sql = "SELECT * FROM hang WHERE MaHS = '$MaHS'";
...
<body>
	<div class="container">
		<form action="processing_edit_Hang.php" method="POST">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<h2 class="text-center">Update Hãng Sữa</h2>
			</div>
			<div class="panel-body">
				<div class="form-group">
				  <label for="usr">Mã Hãng sữa:</label>
				  <input name="MaHS" required="true" type="text" class="form-control" id="usr" value="<?php echo $MaHS ?>" disabled	>
				</div>
				<div class="form-group">
				  <label for="usr">Tên Hãng sữa:</label>
				  <input name="TenHS" required="true" type="text" class="form-control" id="usr" value="<?php echo $TenHS ?>">
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				  ...
				  <input name="DienThoai" required="true" type="text" class="form-control" id="usr" value="<?php echo $DienThoai ?>">
				</div>
				<div class="form-group">
